...
public class Amf0Output extends AbstractAmfOutput implements AmfTypes
{
    ...
    public void writeObject(Object o) throws IOException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                else if (o instanceof Map && context.legacyMap && !(o instanceof ASObject) && !(cls.isAnnotationPresent(MapAsObject.class)))
                {
    ...
    protected void writeCustomObject(Object o) throws IOException
    {
        ...
        if (o instanceof PropertyProxy)
        {
            ...
            else if (context.legacyMap && o instanceof Map && !(o instanceof ASObject) && !(o.getClass().isAnnotationPresent(MapAsObject.class)))
            {
                writeMapAsECMAArray((Map)o);
                return;
            }
