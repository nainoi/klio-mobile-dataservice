...
public class ClassUtil
{
    ...
    public static Class createClass(String type, ClassLoader loader)
    {
        ...
        catch (ClassNotFoundException cnf)
        {
            ...
            ex.setMessage("TYPE_NOT_FOUND");
            ex.setDetails("TYPE_NOT_FOUND");
